...
<div class="card glow-accent" style="margin-top:0.5rem;">
  ...
  <div style="margin-top:0.4rem;" class="section-label">Edge Decay Alert ⚠️</div>
  <div class="grid-2" style="gap:0.3rem;">
    <div class="card" style="padding:0.25rem 0.5rem;display:flex;justify-content:space-between;align-items:center;">
      <span style="font-size:0.72rem;color:var(--fwd-text);">SOL neg% shift</span>
      <span style="font-size:0.65rem;color:var(--fwd-danger);">-20pp ⚠️</span>
    </div>
    <div class="card" style="padding:0.25rem 0.5rem;display:flex;justify-content:space-between;align-items:center;">
      <span style="font-size:0.72rem;color:var(--fwd-text);">BTC/ETH neg%</span>
      <span style="font-size:0.65rem;color:var(--fwd-success);">stable ✅</span>
    </div>
  </div>

  <div class="progress-bar" style="margin-top:0.5rem;"><div class="progress-fill accent" style="width:100%"></div></div>
  <div style="font-size:0.6rem;color:var(--fwd-text-dim);margin-top:0.2rem;">100% complete — 5 uncorrelated signals, SOL edge decaying</div>
</div>
...
<div class="card glow-neutral" style="margin-top:0.5rem;">
  ...
  <div style="margin-top:0.3rem;font-size:0.75rem;color:var(--fwd-text-muted);">90-day paper track record · Edge decay monitoring · Statistical robustness</div>
  <div class="grid-2" style="gap:0.3rem;margin-top:0.4rem;">
    ...
    <div class="card" style="padding:0.25rem 0.5rem;display:flex;justify-content:space-between;align-items:center;">
      <span style="font-size:0.72rem;color:var(--fwd-text);">HL 1h Funding</span>
      <span style="font-size:0.65rem;color:var(--fwd-success);">✓ pipeline</span>
    </div>
    <div class="card" style="padding:0.25rem 0.5rem;display:flex;justify-content:space-between;align-items:center;">
      <span style="font-size:0.72rem;color:var(--fwd-text);">90d Track Record</span>
      <span style="font-size:0.65rem;color:var(--fwd-accent);">⟳ Day 1</span>
    </div>
    <div class="card" style="padding:0.25rem 0.5rem;display:flex;justify-content:space-between;align-items:center;">
      <span style="font-size:0.72rem;color:var(--fwd-text);">Edge Decay Monitor</span>
      <span style="font-size:0.65rem;color:var(--fwd-text-muted);">☐ P0</span>
    </div>
    <div class="card" style="padding:0.25rem 0.5rem;display:flex;justify-content:space-between;align-items:center;">
      <span style="font-size:0.72rem;color:var(--fwd-text);">t-Stat Verification</span>
      <span style="font-size:0.65rem;color:var(--fwd-text-muted);">☐ P0</span>
    </div>
    <div class="card" style="padding:0.25rem 0.5rem;display:flex;justify-content:space-between;align-items:center;">
      <span style="font-size:0.72rem;color:var(--fwd-text);">HL 1h Calibration</span>
      <span style="font-size:0.65rem;color:var(--fwd-text-muted);">☐ P2</span>
    </div>
    <div class="card" style="padding:0.25rem 0.5rem;display:flex;justify-content:space-between;align-items:center;">
      <span style="font-size:0.72rem;color:var(--fwd-text);">4h Alignment</span>
      <span style="font-size:0.65rem;color:var(--fwd-text-muted);">☐ P2</span>
    </div>
    <div class="card" style="padding:0.25rem 0.5rem;display:flex;justify-content:space-between;align-items:center;">
      <span style="font-size:0.65rem;color:var(--fwd-text-muted);">Foundry V13 Cron</span>
      <span style="font-size:0.65rem;color:var(--fwd-text-muted);">☐ W11</span>
    </div>
  </div>
...
<div class="card glow-neutral" style="margin-top:0.5rem;">
  ...
  <div style="margin-top:0.3rem;font-size:0.75rem;color:var(--fwd-text-muted);">HL migration · WS execution · Portfolio risk · Scaling</div>
</div>
