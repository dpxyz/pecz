  ...
  <div class="timeline-roadmap">
    ...
    <div class="phase-card active">
      <div class="phase-header">
        ...
        <div class="phase-status-badge">🔨 Build</div>
      </div>
      <div class="phase-title">Foundry</div>
      <div class="phase-goal">Strategy Factory – KI-Generierung + harte Gates</div>
      <div class="phase-why">🔨 V1 Pipeline gebaut – Mock-Run steht an</div>
    </div>
    ...
    <div class="phase-card blocked">
      ...
      <div class="phase-why">⬜ Wartet auf Phase 7 Foundry</div>
    </div>
